...
- (BOOL) createPathIfNecessary:(NSString *) path skipBackup:(BOOL) skipBackup;
- (long long) sizeOfFilePath:(NSString *) path;
- (long) cleanDirectoryComponents:(NSString *) directory;
